        ...
        members.forEach(m => {
            ...
            <div class="fiche ${isPaid ? 'fiche-paid' : 'fiche-pending'}">
                ...
                <div class="fiche-actions">
                    ...
                    <button class="fiche-btn fiche-btn-delete" onclick="this.dataset.clicks=(parseInt(this.dataset.clicks||0)+1);if(this.dataset.clicks==='1'){this.innerHTML='Confirmer ?';this.style.background='#F44336';this.style.color='#fff';setTimeout(()=>{this.innerHTML='<svg width=14 height=14 viewBox=&quot;0 0 24 24&quot; fill=none stroke=currentColor stroke-width=2><polyline points=&quot;3 6 5 6 21 6&quot;/><path d=&quot;M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2&quot;/></svg>';this.style.background='';this.style.color='';this.dataset.clicks='0'},3000)}else{deleteInscription(${m.id})}"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg></button>
                </div>
            </div>`;
        });
